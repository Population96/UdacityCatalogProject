...
This application was developed for the Udacity Full Stack Web
Developer Nanodegree.  The Item Catalog is designed as a mock store
...
9. The prompt will change and you are now in the virtual environment.
Enter `cd ../../vagrant/catalog` in this new prompt to reach the program's files.
